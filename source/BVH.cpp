...
BvhNode::BvhNode(GeometricObject ** list, int n, float time0, float time1)
{
/*
	int axis = rand()%3;
...
bool 
BvhNode::BvhNode::Hit(const Ray& ray, float tmin, float tmax, ShadeRecord& sr) const
{
/*
...
bool 
BvhNode::BvhNode::BoundingBox(float t0, float t1, AABB& box) const
{
	//b = box;
	return true;
}
